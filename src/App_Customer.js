...
class App extends EnvironmentAsync {
  ...
  render() {
    const { userInfo, cmsSettings, isCMSPortalResponseDone } = this.state;
        ...
        <React.Fragment>
          <Switch>
            <CMSContext.Provider
              ...
              {cmsSettings && cmsSettings?.portalID !== 0 && window.location.pathname != "/expired" && window.location.pathname.indexOf("/Packageview/") < 0 && window.location.pathname.indexOf("/QuickPackageView/") < 0 && window.location.pathname.indexOf("/EmailView/") < 0 && (
                <React.Fragment>
                  {!userInfo && (
                  ...
                  /> */}
                      ...
                      <Route path="/about" component={CMSAbout} />
              ...
              {cmsSettings === null && (window.location.pathname.indexOf("/details/deals/") > -1 || window.location.pathname.indexOf("/customerinquiry/") > -1) && (
                <>
                  <Route
                    path="/details/:module/:id"
                    render={(props) => (
              ...
              {/* {cmsSettings === "" && window.location.pathname.indexOf("/customerinquiry/") > -1 && (
              ...
              {isCMSPortalResponseDone && cmsSettings !== undefined && cmsSettings === null && window.location.pathname.indexOf("/details/deals/") < 0 && window.location.pathname.indexOf("/customerinquiry/") < 0 && window.location.pathname.indexOf("/EmailView/") < 0 && (
                <div
              ...
              {cmsSettings === null && !isCMSPortalResponseDone && (
                <div
                  className="d-flex align-items-center justify-content-center"
