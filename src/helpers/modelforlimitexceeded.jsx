...
class modelforlimitexceeded extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <div className="modal fade show d-block" tabIndex='-1'>
          ...
          >
            <div className="modal-content">
              ...
              <div className="modal-body">{'You have exhausted the freemium plan usage limit. Kindly check usage statistics on dashboard. Subscribe a plan to access all exclusive features.'}</div>
...
export default modelforlimitexceeded;
