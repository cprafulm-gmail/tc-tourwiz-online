...
export const Language = {
  ...
  _copyRightsText: {
    "en-US": "Copyright 2021-2023 by TourWiz",
    "ar-AE": "حقوق الطبع والنشر 2023-2021 بواسطة ترافيلكارما",
    "gu-IN": "TourWiz દ્વારા કૉપિરાઇટ 2021-2023",
  },
  _copyRightsByText: {
  ...
  _lblPanCardWithStar: { "en-US": "PAN Card *", "ar-AE": "الاسم الاخير *", "gu-IN": "અટક *" },
  ...
  _error_middleName_require: {
    "en-US": "Middle Name required",
    "ar-AE": "يجب أن يكون تاريخ انتهاء جواز السفر أكبر من 6 أشهر من تاريخ الوصول",
    "gu-IN": "પાસપોર્ટ સમાપ્તિ તારીખ આગમનની તારીખના 6 મહિનાથી વધુ હોવી જોઈએ",
  },
  ...
  _error_pancard_require: {
    "en-US": "PAN Card Number required",
    "ar-AE": "رقم جواز السفر مطلوب",
    "gu-IN": "પાસપોર્ટ નંબર જરૂરી છે",
  },
  ...
  _sendEmailTemplateMessage: {
    "en-US": "Enter comma separated Email Address to send multiple emails.",
    "ar-AE": "أدخل بريدًا إلكترونيًا مفصولاً بفواصل لإرسال رسائل بريد إلكتروني متعددة.",
    "gu-IN": "બહુવિધ ઇમેઇલ્સ મોકલવા માટે અલ્પવિરામથી અલગ કરેલ ઇમેઇલ દાખલ કરો.",
  },
  ...
  _error_emailTo_email: {
    "en-US": "Please enter valid email address.",
    "ar-AE": "الرجاء إدخال عنوان بريد إلكتروني صالح.",
    "gu-IN": "કૃપા કરીને માન્ય ઇમેઇલ દાખલ કરો.",
  },
  ...
  _ACPercentage: { "en-US": "AC % (Adhoc Markup Percentage)", "ar-AE": "نسبة الربح", "gu-IN": "AC % (Adhoc Markup Percentage)" },
  ...
  _quotationReplaceKey: { "en-US": "Proposal", "ar-AE": "موعد الدفع" },
  _quotationReplaceKeys: { "en-US": "Proposals", "ar-AE": "موعد الدفع" },
  ...
  _startDate: { "en-US": "Start Date", "ar-AE": "تاريخ البدء", "gu-IN": "પ્રારંભ તારીખ" },
  _endDate: { "en-US": "End Date", "ar-AE": "تاريخ الانتهاء", "gu-IN": "અંતિમ તારીખ" },
  _lblAgentProcessingFee: { "en-US": "Processing Fee", "ar-AE": "", "gu-IN": "", }
};
