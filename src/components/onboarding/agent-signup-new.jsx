...
class AgentSignUpNew extends Form {
  state = {
    data: {
      ...
      captcha: "",
      signupManager: this.props.isAdminSignup ? "unassigned" : null,
      signupIPDetails: "",
    ...
    isEmailOTP: this.props.isAdminSignup ? true : true,
  ...
  handleEmailOTP = (isForOTPVarify) => {
    ...
    apiRequester_unified_api(reqURL, reqOBJ, (dataRes) => {
      if (dataRes.code && dataRes.code === 2) {

        this.setState({
          isEmailLoading: false,
          isRegistering: false,
          isRegisterFailed: true,
          userExistErrorMsg: "Email address is already taken.",
        });
      }
      else if (dataRes?.result === "ok") {
        if (isForOTPVarify) {
          const { data } = this.state;
          data.emailOtp = "";
          this.setState({
  ...
  handleRegistration = () => {
    ...
    var reqOBJ = {
      ...
      signupManager: data.signupManager,
      ...
      if (data?.status) {
        ...
        if (this.props.match?.params?.plandetail) {
          ...
          if (this.props.location.pathname === "/signup-hajj-umrah")
            ...
            this.props.history.push("/" + modePath + "thankyou")
      ...
      <div>
          ...
          <div>
              ...
              <div className="row">
                <Helmet>
                  <title>
                    ...
                    {/* {signUpMode === "hajj-umrah" ? "Signup-Hajj-Umrah" : "Signup"} | Tourwiz */}
                  </title>
                </Helmet>
            ...
            {isEmailEntered && isEmailOTP && !isEmailOTPValidate && (
              <div className="row">
                <Helmet>
                  <title>
                    {signUpMode === "hajj-umrah" ? "Signup-Hajj-Umrah - OTP Verification" : "Signup - OTP Verification"} | Tourwiz
                  </title>
                </Helmet>
            ...
            {isEmailEntered && (isEmailOTP ? isEmailOTPValidate : true) && (
              <div className="row">
                <Helmet>
                  <title>
                    {signUpMode === "hajj-umrah" ? "Signup-Hajj-Umrah - Details" : "Signup - Details"} | Tourwiz
                  </title>
                </Helmet>
                <div className="col-lg-12">
                  {this.renderInputParam({
        ...
        {isRegisterSuccess && (
          <div>
            <Helmet>
              <title>
                {signUpMode === "hajj-umrah" ? "Signup-Hajj-Umrah - Thank You" : "Signup - Thank You"} | Tourwiz
              </title>
            </Helmet>
        ...
        {isRegisterFailed && !userExistErrorMsg && (
          <div>
        ...
        {isRegisterFailed && userExistErrorMsg && (
          <div>
            ...
            <p className="mt-3 mb-5 text-center">{userExistErrorMsg}</p>
            <p className="mt-3 mb-5 text-center">Please <button
              className="btn btn-sm btn-link text-primary"
              onClick={() => this.props.setForgotPasswordVisible()}
            >click here</button> to generate a password for your account.</p>
          </div>
        )}
...
const employeeList = [{ name: "Select", value: "unassigned" },
{ name: "Shivani Nagvekar", value: "Shivani Nagvekar" },
{ name: "Nikita Panchal", value: "Nikita Panchal" },
{ name: "Arti Thorat", value: "Arti Thorat" },
{ name: "Kapil Bhalerao", value: "Kapil Bhalerao" },
{ name: "Yash Vaishnav", value: "Yash Vaishnav" },
{ name: "Dipashri Desai", value: "Dipashri Desai" },
{ name: "Hetal Khapare", value: "Hetal Khapare" },
{ name: "Marketing Manager", value: "Marketing Manager" },
{ name: "Utkarsha Dethe", value: "Utkarsha Dethe" },
{ name: "Asmita Patil", value: "Asmita Patil" },
{ name: "Ajay Khadge", value: "Ajay Khadge" },
{ name: "Nayana Swami", value: "Nayana Swami" },
{ name: "Supriya Mishra", value: "Supriya Mishra" },
{ name: "Harish Doshi", value: "Harish Doshi" },
{ name: "Prachi Thokale", value: "Prachi Thokale" },
{ name: "Shabbir Jafri", value: "Shabbir Jafri" },
{ name: "Sneha Gaikwad", value: "Sneha Gaikwad" },
{ name: "Yamini Kanojia", value: "Yamini Kanojia" },
{ name: "Monali Mavjekar", value: "Monali Mavjekar" },
{ name: "Tejasvi Bavadane", value: "Tejasvi Bavadane" },
{ name: "Shifa Dongarkar", value: "Shifa Dongarkar" },
{ name: "Kajal Bacche", value: "Kajal Bacche" },
{ name: "Urmila Devda", value: "Urmila Devda" },
{ name: "Agent Manager", value: "Agent Manager" }
]
