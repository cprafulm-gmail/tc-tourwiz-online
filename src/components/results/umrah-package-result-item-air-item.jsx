...
const UmrahPackageResultItemAirItem = (props) => {
  const { items } = props;
  let isWishList =
      ...
      <div className="col-lg-10">
        <ul className="list-unstyled m-0">
          {items.map((item, itemKey) => {
            ...
            const cabinClass = item.item[0].tpExtension.find((x) => x.key === "cabinClass")
              ...
              <li className="p-3" key={itemKey}>
                <div className="row">
                  ...
                  <div className="col-lg-2 d-flex justify-content-center align-items-start flex-column">
                    ...
                    <span className="small text-nowrap text-secondary mt-1">{cabinClass}</span>
                  </div>
                </div>
              </li>
            );
      ...
      <div className="col-lg-2 border-left bg-light d-flex justify-content-center align-items-center flex-column">
        ...
        {props.isBtnLoading === false ? (
          <button
            ...
            onClick={() => props.handleCart(props.token, props.token, "", props)}
          >
            Add to {props.type}
          </button>
        ) : (
        ...
        {props.tpExtension.find((x) => x.key === "providername") !== undefined &&
...
export default UmrahPackageResultItemAirItem;
