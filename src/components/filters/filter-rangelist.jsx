...
class FilterRangeList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isShow: false
                      ...
                      <li key={key}>
                        <div className="custom-control custom-checkbox m-0">
                          <input
                            ...
                            type="checkbox"
                            id={name + item.minValue + item.maxValue}
                            value={name + item.minValue + item.maxValue}
                            name={name + item.minValue + item.maxValue}
                          />
                          <label
                            name={name + item.minValue + item.maxValue}
                            htmlFor={name + item.minValue + item.maxValue}
...
export default FilterRangeList;
