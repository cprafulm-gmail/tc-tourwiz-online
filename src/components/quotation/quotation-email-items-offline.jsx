...
const QuotationEmailItemsOffline = (props) => {
                        ...
                        <table cellPadding="0" cellSpacing="0" border="0" width="100%">
                          <tbody>
                            <tr>
                              ...
                              >
                                {ShowhideElementname === "showAllPrices" && props.isRemovePriceAndActionButton && (
                                  <h5
                                    style={{
                                      fontSize: "20px",
                                      color: "#f18247",
                                  ...
                                  >
                                    <Amount amount={(item.totalAmount && Number(item.totalAmount) > 0) ? item.totalAmount : item.sellPrice}></Amount>
                                  </h5>
                                )}
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td valign="top">
                                <table cellPadding="0" cellSpacing="0" border="0" width="100%">
                                  <tbody>
                                    <tr>
                                      {props?.isRemovePriceAndActionButton &&
                                        showImagesInEmail &&
                                        ...
                                        >
                                          {props?.isRemovePriceAndActionButton &&
                                            <tbody>
                                              ...
                                              {(item.business === "activity" ||
                                                item.business === "transfers") && item.pickupTime && (
                                                  <tr>
                                                    <td
                                                      style={{
                                                        fontSize: "14px",
                          ...
                          <tr>
                            ...
                            >
                              {(props.type !== "ItineraryItem" ||
                                ...
                                (ShowhideElementname === "showAllPrices" || ShowhideElementname === "isShowFlightPrice") &&
                                props.isRemovePriceAndActionButton && (
                                  <h5
                                    style={{
                                      fontSize: "20px",
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        >
                                                          ...
                                                          <span>
                                                            <b>Stop(s): </b>
                                                            {Array.isArray(item.departStops) ? item.departStops.length : item.departStops} stop(s)
                                                          </span>
                                                          {", "}
                                                          <span>
                                                            <b>Duration: </b>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        >
                                                          ...
                                                          <span>
                                                            <b>Stop(s): </b>
                                                            {Array.isArray(item.returnStops) ? item.returnStops.length : item.returnStops} stop(s)
                                                          </span>
                                                          {", "}
                                                          <span>
                                                            <b>Duration: </b>
...
export default QuotationEmailItemsOffline;
