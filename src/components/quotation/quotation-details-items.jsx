...
class QuotationDetailsItems extends Component {
  constructor(props) {
    super(props);
  ...
  handleBookItemChange = (e) => {
    let target = e.target;
    this.props.getselecteditemstoBook(target.value);
  }
  ...
  render() {
    const { item, userInfo, type } = this.props;
    ...
    if ((item.offlineItem.business || item?.itemDtl?.business).toLowerCase() === "package") return <React.Fragment></React.Fragment>;
    return (
          ...
          <React.Fragment>
            {item.offlineItem && (
              <div className="row">
                        ...
                        <div className="d-flex align-items-center">
                          {localStorage.getItem("portalType") !== "B2C"
                            ...
                            <input
                              ...
                              value={item.offlineItem.uuid}
                              checked={item.Selected}
                              onChange={(e) => { this.handleBookItemChange(e) }}
                            />
                          }
                          <div
                          ...
                          <div className="quotation-details-item-title ml-3">
                            ...
                            {this?.props?.isRemovePriceAndActionButton && item.offlineItem.business === "hotel" && item.offlineItem.toLocation && (
                              <small className="mt-1 mr-3 text-secondary">
                                <SVGIcon
                                  name="map-marker"
                                  width="16"
                        ...
                        <div className="quotation-details-item-col col-lg-4 d-flex align-items-center">
                          <div>
                            ...
                            <div>
                              ...
                              {item.offlineItem.business === "custom" && item.offlineItem.day !== "All Days" && type !== "Quotation" && (
                                <small className="text-secondary">
                                  {item.offlineItem.toLocation && item.offlineItem.toLocation + " - "}
                                  <Date date={item.offlineItem.startDate} />
                                </small>
                              ...
                              <div className="col-lg-12">
                                <div className="mt-3">
                                  <div className="row">
                                    <div className={"quotation-details-item-col col-lg-5 d-flex align-items-center " + item.offlineItem.business}>
                                      <div
                                        className={type == 'Quotation' ? "ml-4 border rounded bg-white d-flex align-items-center justify-content-center" : "border rounded bg-white d-flex align-items-center justify-content-center"}
                                        style={{ height: "48px", width: "48px" }}
                                      >
                                        <SVGIcon
                                          className="d-flex align-items-center text-primary"
                ...
                {localStorage.getItem("portalType") !== "B2C" &&
                  item.offlineItem.business !== 'package' &&
                  <React.Fragment>
                    {(item.offlineItem.business !== "air" ||
                      (this.props.departFlight && !this.props.returnFlight) ||
                      (!this.props.departFlight && !this.props.returnFlight)) &&
                        ...
                        <div className="quotation-details-item-col quotation-details-item-col-price col-lg-2 d-flex align-items-center justify-content-end">
                          {isPringAllowed &&
                            ...
                            >
                              ...
                              {item.offlineItem.business === "air" &&
                                <small className="d-block text-secondary mt-2" style={{ fontSize: "0.7rem" }}>
                                  {item.offlineItem.adult > 0 && parseInt(item.offlineItem.adult) + " Adult(s)"}
                                  {item.offlineItem.child > 0 && ", " + parseInt(item.offlineItem.child) + " Child(ren)"}
                                  {item.offlineItem.infant > 0 && ", " + parseInt(item.offlineItem.infant) + " Infant(s)"}
                                </small>
                              }
                              ...
                              >
                                ...
                                {item.offlineItem.supplierCurrency && (
                                  <li className="text-nowrap pb-3">
                                    Supplier Currency : <b>{item.offlineItem.supplierCurrency}</b>
                                  </li>
                                )}
                                {item.offlineItem.conversionRate && (
                                  <li className="text-nowrap pb-3">
                                ...
                                {Number(totalTaxAmount) > 0 && (
                                  <li className="text-nowrap pb-3">
                                    Tax (All Inclusive):{" "}
                                    <b>
                                      <Amount amount={totalTaxAmount}></Amount>
                                    </b>
                                  </li>
                                )}
                                ...
                                {Number(item.offlineItem.discountPrice) > 0 && (
                                  <li className="text-nowrap pb-3">
                                    Discount :{" "}
                                    <b>
                                      <Amount amount={item.offlineItem.discountPrice}></Amount>
                                    </b>
                                  </li>
                                )}

                                {Number(item.offlineItem.sellPrice) >= 0 && (
                                  <li className="text-nowrap pb-3">
                                    Sell Price :{" "}
                                    <b>
                                      <Amount amount={item.offlineItem.totalAmount > 0 ? item.offlineItem.totalAmount : item.offlineItem.sellPrice}></Amount>
                                    </b>
                                  </li>
                                )}
                          ...
                          {quotationInfo.status.toLowerCase() !== "booked" &&
                            <AuthorizeComponent title={"IitineraryDetails~" + tmpTypeConcate + "itineraries-edit-item"}
                              type="button"
                          ...
                          {quotationInfo.status.toLowerCase() !== "booked" &&
                            <AuthorizeComponent title="ItineraryDetails~itineraries-delete-item" type="button" rolepermissions={this.props.userInfo.rolePermissions}>
                              <button
...
export default QuotationDetailsItems;
