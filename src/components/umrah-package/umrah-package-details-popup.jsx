...
class UmrahPackageDetailsPopup extends ResultBase {
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  {details.name ? details.name : "Loading Details..."}
                </h5>
                    ...
                    <div className="col-lg-12">
                      <div className="quick-book-cont">
                        <ul className="nav nav-pills bg-light p-2">
                          ...
                          {businessName === "hotel" &&
                            details.locationInfo.fromLocation.latitude &&
                            details.locationInfo.fromLocation.longitude &&
                            details.locationInfo.fromLocation.city && (
                              <li className="nav-item">
                                <button
                                  onClick={() => this.changeTabs("map")}
                                  className={tab === "map" ? activeClass : defaultClass}
                                >Map</button>
                              </li>
                            )}
                        </ul>
                            ...
                            <div className="pt-3 pl-2">
                              ...
                              {tab === "map" && (
                                <MapComponent
                                  ...
                                  cityName={details.locationInfo.fromLocation.city}
                                  businessName={businessName}
                                  defaultZoom={14}
                                  page={"detail"}
                                />
...
export default UmrahPackageDetailsPopup;
