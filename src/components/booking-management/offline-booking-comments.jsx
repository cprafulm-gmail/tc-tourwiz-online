...
class OfflineBookingComments extends Component {
  ...
  handleSubmit = () => {
    ...
    this.props.updateOfflineBooking(req);
  };
  ...
  render() {
    const { isCancellationCharges, isBtnLoading, isShowComments } = this.state;
    const { offlineComment, mode } = this.props;
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title text-capitalize">
                  {mode === "view" ? Trans("_viewComments") : Trans("_processRequest")}
                </h5>
                <button
                  type="button"
                  className="close"
                      ...
                      <div className="col-lg-6">
                        ...
                        <ul className="list-unstyled">
                          <li>
                            ...
                            <span>{details.name ? details.name : details?.travellerDetails.length > 0 ? details?.travellerDetails[0].details?.userDisplayName : ""}</span>
                          </li>
                          ...
                          <li>
                            ...
                            <span>{details.email ? details.email : details?.travellerDetails.length > 0 ? details?.travellerDetails[0].details?.contactInformation?.email : ""}</span>
                          </li>
                          ...
                          <li>
                            ...
                            <span>{details.changeRequestPhone ? details.changeRequestPhone : details?.travellerDetails.length > 0 ? details?.travellerDetails[0].details?.contactInformation?.homePhoneNumberCountryCode + "-" + details?.travellerDetails[0].details?.contactInformation?.homePhoneNumber : ""}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-3">
                            ...
                            <b className="d-block mt-1">
                              <Amount amount={details.amount ? details.amount : details.businessObject.amount} />
                            </b>
                          </div>

                          <div className="col-lg-2">
                            <label>{Trans("_viewFees")} : </label>
                            <b className="d-block mt-1">
                              <Amount amount={details.fess} />
                            </b>
                          </div>
                        </div>
