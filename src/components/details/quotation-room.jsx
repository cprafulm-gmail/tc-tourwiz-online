...
class QuotationRoom extends React.Component {
  render() {
    return (
      <ul
        className={
      ...
      >
        <li className="col-lg-2" style={{ display: "none" }}>
          <img
            className="img-fluid"
        ...
        <li
          className={
            this.props.rooms.flags["isGroupedRooms"] === undefined ||
            this.props.rooms.flags["isGroupedRooms"] === false
              ? "col-lg-5 p-2 d-flex align-items-center"
              : "col-lg-5 p-2 d-flex align-items-center"
          }
        >
          ...
          <div style={{ display: "none" }}>
            ...
            <div className="mt-2">
              {this.props.data.boardTypes !== undefined &&
                this.props.data.boardTypes.length > 0 && (
                  <React.Fragment>
                    <small className="mr-2">{Trans("_boardTypes")} : </small>
                    {this.props.data.boardTypes !== undefined
                      ? this.props.data.boardTypes.map(function (
                          boardTypes,
                          key
                        ) {
                          return (
            ...
            <div className="mt-2">
              {this.props.data.tpExtension.find(
                (x) => x.key === "promotionName"
              ).value !== "" && (
                          ...
                          function (amenities, key) {
                            return key === 3 ? (
                              <span
                                key={key}
                                onClick={() =>
                                  this.props.ShowRoomDetails(this.props.data)
                                }
                                className={
            ...
            <div>
              ...
              <span style={{ opacity: ".7" }} className="text-nowrap">
                <PaxIcons
                  type="adult"
                  {...[
                    this.props.data.tpExtension.find((x) => x.key === "adults")
                      .value,
                  ]}
                />
                  ...
                  <input
                    ...
                    checked={
                      this.props.selectedRooms.find(
                        (x) =>
                          x.groupid === this.props.rooms.id &&
                          x.roomCode === this.props.data.code
                      ) !== undefined
                        ? true
                        : false
                    }
