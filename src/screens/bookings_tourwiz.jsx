...
class MyBookings extends BookingBase {
  constructor(props) {
    ...
    this.state = {
      ...
      type: "upcoming",
      pageLength: 10,
      defaultFilters: this.props.match.params.frompaperrate ? [
        {
  ...
  handleHideEticketPopup = () => {
    this.setState({ isshowTicketPopup: !this.state.isshowTicketPopup, brnBookingDetails: null });
  }
  handleEticket = (booking, itinerary, brn) => {
    this.setState({
      isshowTicketPopup: !this.state.isshowTicketPopup, brnBookingDetails: null,
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-5 d-flex justify-content-end">
                <AuthorizeComponent title="bookings~customer-bookings-import" type="button" rolepermissions={this.props.userInfo.rolePermissions ? this.props.userInfo.rolePermissions : null}>
                  <button
                    className="btn btn-primary ml-3"
                    // onClick={this.props.history.push("/ImportBookings")}
                    onClick={() => !GlobalEvents.handleCheckforFreeExcess(this.props, "bookings~customer-bookings-import") && this.state.isCustomerPage ? this.setState({ isSubscriptionPlanend: true }) :
                      AuthorizeComponentCheck(this.props.userInfo.rolePermissions, "bookings~customer-bookings-import") ?
                        this.props.history.push("/ImportBookings")
        ...
        <div className="container">
          {this.state.isLoginError ? (
            ...
            <React.Fragment>
              ...
              <BookingFilters {...this.props} filterResults={this.filterResults} page={page} rolepermissions={this.props.userInfo.rolePermissions} />
                            ...
                            >
                              ...
                              <li className="col-lg-4 mb-3">
                                <div className="row">
                                  ...
                                  <b className="col-lg-12">{booking.email.endsWith(process.env.REACT_APP_B2CPORTALDOMAINFORCUSTOMER.replace(".", "@")) ? '---' : booking.email}</b>
                                </div>
                              </li>
                                ...
                                <div className="row">
                                  <div className="col-lg-12">
                                    <div className="mt-2">
                                      ...
                                      {booking.flags.allowcancellation && booking.sellPrice > 0 &&
                                        <React.Fragment>
                                          {booking.flags.allowcancellation && (
                                            <AuthorizeComponent title="bookings~customer-bookings-cancel" type="button" rolepermissions={this.props.userInfo.rolePermissions}>
                                              {!booking.isPaperRateBooking &&
                                                <button
                                                  className="btn btn-sm btn-light text-secondary mr-2"
                                                  onClick={() => AuthorizeComponentCheck(this.props.userInfo.rolePermissions, "bookings~customer-bookings-cancel")
                                                    ? this.redirectToDetails("cancel", itinerary, booking.bookingRefNo)
                                                    : this.setState({ isshowauthorizepopup: true })}
                                                >
                                                  <SVGIcon
                                                    name="ban"
                                          ...
                                          {booking.flags
                                            .allowcancellation && (
                                              <AuthorizeComponent title="bookings~customer-bookings-modify" type="button" rolepermissions={this.props.userInfo.rolePermissions}>
                                                {!booking.isPaperRateBooking && Config.codebaseType !== "tourwiz" &&
                                                  <button
                                                    className="btn btn-sm btn-light text-secondary mr-2"
                                                    onClick={() => AuthorizeComponentCheck(this.props.userInfo.rolePermissions, "bookings~customer-bookings-modify") ? (this.handleComingSoon()) : this.setState({ isshowauthorizepopup: true })}
                                                  >
                                                    <SVGIcon
                                                      name="pencil-alt"
                                                      className="mr-1"
