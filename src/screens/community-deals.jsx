...
class CommunityDeals extends Component {
    state = {
        blogPosts: [],
        items: [],
        isLoading: true,
                                ...
                                <div className="container">
                                    <div className="row">
                                        {blogPosts.map((item, key) => {
                                            return (
                                                <div className="col-lg-3 mb-3" id={key} key={key} style={{ display: "flex" }}>
                                                    <div className="tw-reasons-box p-0 border" style={{ backgroundColor: "#fff", alignItems: "inherit" }}>
