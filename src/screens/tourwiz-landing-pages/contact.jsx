  ...
  handleEnquiryEmail = () => {
    let reqOBJ = {
      request: {
        ...
        HearAboutUs: this.state.data.howdidhearabout,
        HelpText: this.state.data.comments,
        IsAllowCommunications: this.state.isAgreeTerms ? "Yes" : "No",
        IsAllowPersonalInformation: this.state.isAgreeReceive ? "Yes" : "No"
      }
    };
    ...
    return (
      <div className="tw-public-pages tw-contact-page">
        ...
        <Helmet>
          ...
          <meta
            name="description"
            content="If you’ve got questions about the product, pricing or anything else, feel free to reach out to us."
          />
        </Helmet>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="tw-contact-details mb-4">
                  ...
                  <a href="mailto:sales@tourwizonline.com" className="d-block ml-1 mb-4">
                    <SVGIcon
                      name="envelope"
                      width="16"
                      height="16"
                ...
                {/* <Link to="/book-demo" className="btn-book-demo-contact">Book a Demo</Link> */}
              </div>
            </div>
          </div>
