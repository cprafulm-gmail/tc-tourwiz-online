  ...
  header, footer, .agent-login, .landing-pg {
    ...
    return (
      <div className="tw-public-pages tw-offers-page">
        ...
        <Helmet>
          <title>Tourwiz | Marketplace</title>
          <meta
            name="description"
            content="Get access to amazing deals from our trusted Marketplace when you sign up. Trusted by 26000+ Travel Professionals Globally. "
          />
        </Helmet>
