    ...
    return (
      <div className="mb-3 col-12 pl-0 pr-0">
        <div className="border pt-2 pb-2 pl-3 pr-3 shadow-sm">
          ...
          <div className="row">
            <div className={this.props.isFromContentManager ? "d-none" : "col-lg-3"}>
              {this.renderSelect("packagetheme", "Type", themeType)}
            </div>
            <div className="col-lg-3">
              {this.renderInput("packagename", "Title")}
            </div>
            {/* <div className="col-lg-3">
            ...
            <div className="col-lg-3">
              {this.renderSelect("rating", "Rating", startRating)}
            </div>
            <div className="col-lg-3">
...
const themeType = [
  { value: "0", name: "Select" },
  { value: "1", name: "Popular Hotels" },
  { value: "3", name: "Popular Flights" },
  { value: "2", name: "Visa Destinations" },
];
