        ...
        <div className="border-bottom bg-light d-flex p-2 pl-3 pr-3">
          <div className="mr-auto d-flex align-items-center">
            <SVGIcon
              ...
              type="fill"
            ></SVGIcon>
            <h6 className="font-weight-bold m-0 p-0">Itinerary Email</h6>
          </div>
        ...
        <div className="p-3">
          ...
          {isSucessMsg && (
            <h6 className="alert alert-success mt-3">
              Itinerary {saveMode && "Save and "} Sent Successfully!
            </h6>
          )}
          ...
          <div className="mt-2">
            <button
              ...
              onClick={() => true ? this.packageEmailPreview() : this.setState({ isshowauthorizepopup: true })}>
              Preview Email
            </button>

            <button
              className="btn btn-sm btn-primary mr-3"
              onClick={() => true ? this.sendEmail() : this.setState({ isshowauthorizepopup: true })}
            >
            ...
            {/* <button
              className="btn btn-sm btn-primary mr-3"
              onClick={() => true ? this.packageSupplieritinerany() : this.setState({ isshowauthorizepopup: true })}>
