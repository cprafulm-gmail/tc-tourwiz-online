...
const MarketplaceDeals = (props) => {
  ...
  const IsCMS = location.pathname.indexOf("/marketplace") > -1 ? true : false;
  ...
  }, [state.currentPage, localStorage.getItem('portalType')]);
  // useEffect(() => {
  //   debugger;
  //   (async function () {
  ...
  const handleMorePopup = (title) => {
    setState((prevState) => {
      return {
        ...prevState,
        popupTitle: state.showPopup ? "" : title,
        showPopup: !state.showPopup,
        popupContent: state.showPopup ? (
          ""
        ) : (
          <div>
            <div>Deal details is not available.</div>
            <div className="mt-3">Kindly contact admin <a className="text-primary mb-1"
              href={"mailto:" + Global.getEnvironmetKeyValue("customerCareEmail")}
            >
  ...
  .cp-home-deals { background: none; }
      ...
      .AF-005 .cp-home-our-service .our-services-icon {
  ...
  const cmsCSS = `body .showMoreDiv {
        text-align: center;
        background: rgb(241, 130, 71) !important;
        overflow: hidden; 
        width: 237px !important;
    }
    .AF-001 .populer-deals .btn {
      background: rgb(241, 130, 71) !important;
      color: #fff !important;
    
    }
    .AF-001 .populer-deals .btn:hover {
      background: rgb(241, 130, 71) !important;
      color: #fff !important;
  ...
  return (
    <div className="profile">
      <Helmet>
        <title>
          {location.pathname.indexOf("/Preview") > -1 ? "TourWiz - Marketplace Preview" : "Marketplace Deals - Customer Website"}
        </title>
      </Helmet>
      {IsCMS && <style>{cmsCSS}</style>}
        ...
        <div className="container">
          <h1 className="text-white m-0 p-0 f30">
            <SVGIcon
              ...
              className="mr-3"
            ></SVGIcon>
            {location.pathname.indexOf("/Preview") > -1 ? "Marketplace" : "Offers"}

            {location.pathname.indexOf("/Preview") > -1 && <sup style={{ fontSize: "11px", top: "-1.5em" }}>BETA</sup>}
          ...
          <div className="container">
            ...
            <div className="row">
              {state.totalRecords > 0 && results
                ? results.map((x, key) => {
                  const [convertedPrice, convertedCurrency] = PriceConverter({ amount: x?.price, currentCurrency: props.ipCurrencyCode || "INR" });
                  return (<div key={x.packageThemeID} className="col-lg-3 mb-4">
                    <div
                    ...
                    >
                      ...
                      <div className="p-2 populer-deals-content bg-white">
                        ...
                        <div className="clo-lg-12 mb-2 font-weight-bold price">
                          {x?.price > 0 && (
                            <>
                              Starting at
                              <span
                          ...
                          {x?.offerPrice > 0 && (
                            <span
                              className="text-dark ml-2 font-weight-bold d-none "
                        ...
                        <div
                          className="clo-lg-12 d-block showMoreDiv"
                          style={{
                            position: "absolute",
                            bottom: "9px",
                            width: "285px",
                        ...
                        >
                          {/* {Config.codebaseType === "tourwiz-customer" && window.location.origin.toLowerCase().indexOf(process.env.REACT_APP_DEFAULTB2CPORTAL) > -1 ?
                            <label className="btn btn-lg btn-primary showMore text-white mt-1 pt-1 pb-1 shadow w-100 rounded-0 "
                              onClick={() => handleMorePopup(x?.shortDescription)}
                            >More</label> : */}
                          <Link
