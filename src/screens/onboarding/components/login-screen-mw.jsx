...
import LoginScreenMWRightContent from "./login-screen-mw-right-content";
import LoginScreenMWRightContentAI from "./login-screen-mw-right-content -ai";
...
class LoginScreenMW extends Component {
  ...
  handleRegistrationForm = () => {
    ...
    this.props.history.push("/" + modePath + page);
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    let page = this.props.location.pathname.indexOf("/signin") > -1 ? "signin" : "signup";
          ...
          <StickyContainer>
            ...
            <div className="container position-relative onboarding-main-page">
              <div className="row">
                    ...
                    {window.location.host !== 'partners.travelcarma.com' && window.location.host !== 'partners.tourwizonline.com' && isRegistrationForm && page === "signup" && (
                      <div className="mb-4">
                        <AgentSignUpNew
                          ...
                          isAdminSignup={this.props.isAdminSignup}
                          setForgotPasswordVisible={this.setForgotPasswordVisible}
                        />
                      </div>
                    )}
                ...
                {page === "signin" ? (<div className="col-lg-8 signin-img-col">
                  ...
                  {/* {this.props.match.params.mode === "ai" ?
                    <LoginScreenMWRightContentAI page={page} /> :
                    <LoginScreenMWRightContent page={page} />
                  } */}
