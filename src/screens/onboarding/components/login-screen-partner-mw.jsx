              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="pt-4">
                    ...
                    {window.location.host === 'localhost:3000' && window.location.host !== 'partners.travelcarma.com' && window.location.host !== 'partners.tourwizonline.com' && window.location.host !== 'localhost:3000' && isRegistrationForm && page === "signup" && (
                      <div className="mb-4">
                        <AgentSignUpNew
