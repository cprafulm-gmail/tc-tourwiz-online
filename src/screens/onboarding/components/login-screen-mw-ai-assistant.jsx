...
class LoginScreenAiAssistant extends Component {
  constructor(props) {
    super(props);
    this.state = {
      page: "",
  ...
  handleRegistrationForm = () => {
    let page = this.state.page === "signin-ai-assistant" ? "signup-ai-assistant" : "signin-ai-assistant";
    this.props.history.push("/" + page);

    this.setState({
      isRegistrationForm: this.state.page === "signin-ai-assistant" ? false : true,
      page,
    });
  };
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    let page = this.props.location.pathname === "/signin-ai-assistant" ? "signin-ai-assistant" : "signup-ai-assistant";
    page = this.props.isRedirectToRequestedURL ? "signin-ai-assistant" : page;
    this.setState({
      page,
      isRegistrationForm: page === "signin-ai-assistant" ? false : true,
    });
  }
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="pt-4">
                    ...
                    {window.location.host !== 'partners.travelcarma.com' && window.location.host !== 'partners.tourwizonline.com' && isRegistrationForm && page === "signup-ai-assistant" && (
                      <div className="mb-4">
                        <AgentSignUpNew
                ...
                {page === "signin-ai-assistant" ? (<div className="col-lg-8 signin-img-col">
                  <>
                  ...
                  <div className={page === "signin-ai-assistant" ? "signin-img signup-img" : "signup-img"}>
                    <img
                      src={page === "signin-ai-assistant" ? SigninBgImg : SignupBgImgStep1}
                      alt=""
                    />
                  </div>
...
export default LoginScreenAiAssistant;
