...
import LoginScreenMW from "./screens/onboarding/components/login-screen-mw-tripcentre";
...
import CMSDealsList from "./screens/cms/AF-005/cms-deals-list";
...
import CMSInquiry from "./screens/cms/AF-005/cms-inquiry";
...
const PaperRateResults = lazy(() => import('./screens/paper-rates-users-list'));
...
const PaperRatesResults = lazy(() => import('./screens/paper-rates-users-list'));
const BookingsPaperRates = lazy(() => import('./screens/bookings_tourwiz_paperrates'));


class AppTripCenter extends EnvironmentAsync {
  ...
  render() {
    ...
    const { userInfo, isB2BLoggedIn, cmsSettings, cmsContents } = this.state;
    ...
    return (
      <React.Fragment>
        ...
        <Switch>
          ...
          <CMSContext.Provider
            value={cmsCtx} >
            {!userInfo && role === null && cmsSettings && (
              <div className={Config.codebaseType === undefined || Config.codebaseType === "tourwiz-tripcenter" ? cssClass : ""}>
                ...
                <StickyContainer>
                  ...
                  />
                  {/* {Config.codebaseType === "tourwiz-tripcenter" && window.location.hostname === "agents.thetripcentre.com" && ( */}
                  <Route
                    key="signup"
                    path="/signup"
                    render={(props) => (
                  ...
                  {/* )} */}
                  {/* {(portalType === "B2B" || portalType === "BOTH") &&
                isB2BLoggedIn === false && cmsSettings && (Config.codebaseType === undefined || Config.codebaseType === "tourwiz-tripcenter") && componentAbout} */}
                  ...
                  />
                  <Route path="/terms"
                    render={(props) => <CMSTerms userInfo={userInfo} {...props} {...this.state} />}
                  />
                  <Route
                ...
                isB2BLoggedIn === false && ( */}
                  <Route
                    ...
                    render={(props) =>
                      ...
                      window.location.pathname !== "/signup" && (
                        Config.codebaseType === undefined || Config.codebaseType !== "tourwiz-tripcenter" || (Config.codebaseType === "tourwiz-tripcenter" && window.location.hostname === "agents.thetripcentre.com") ?
                          (<LoginScreenMW
                            {...props}
                            {...this.state}
                            userInfo={userInfo}
                  ...
                  {/* // )} */}
                  {/* {(portalType === "B2B" || portalType === "BOTH") &&
                  isB2BLoggedIn === false && cmsSettings && cmsContents && (Config.codebaseType === undefined || Config.codebaseType === "tourwiz-tripcenter") ? <CMSCopywrite05 {...this.state} /> : <CMSCopywrite {...this.state} />} */}
                </StickyContainer>
              </div>)}
                  ...
                  <Suspense fallback={this.getLoaderContent()}>
                    ...
                    {userInfo ? (
                      <React.Fragment>
                        ...
                        />
                        <Route path="/Bookings/:frompaperrate?"
                        ...
                        />
                        {/* <Route
                          path="/paperratesresults"
                          render={(props) => (
                            <PaperRatesResults  {...props} {...this.state} />
                          )}
                        /> */}
                        <Route
                          path="/PaperRatesResults/:businessName/:locationName?/:locationID?/:countryID?/:checkInDate?/:checkOutDate?/:roomDetails?/:filters?"
                          component={PaperRateResults}
                        />
                      </React.Fragment>
                    ) : (
